...
//
// Bootup the masternode, look for a 30000 MRJA input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* rewards are not supported in Ganjaproject.conf */
            ...
            notCapableReason = "Successfully started masternode remotely.";
        	LogPrintf("CActiveMasternode::ManageStatus() - Successfully started masternode remotely.\n");
        }
    }
